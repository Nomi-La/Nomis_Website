...
class Section(models.Model):
    ...
    image = models.ImageField(upload_to='section_images/', validators=[mb_size(1.5)], null=True, blank=True)
    image2 = models.ImageField(upload_to='section_images/', validators=[mb_size(1.5)], null=True, blank=True)
